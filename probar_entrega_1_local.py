...
def probar_codigo(interactivo=False, saltear_errores=False):
    ...
    pruebas = (
        ('hill_climbing', dict(iteraciones=200)),
        ('hill_climbing_stochastic', dict(iteraciones=200)),
        ('beam', dict(iteraciones=200, haz=20)),
        ('hill_climbing_random_restarts', dict(iteraciones=200, reinicios=20)),
        ('simulated_annealing', dict(iteraciones=200)),
    )
